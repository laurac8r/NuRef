...
void G02RunAction::EndOfRunAction(const G4Run* run)
{
if (G4VVisManager::GetConcreteInstance())
  ...
  const G02PrimaryGeneratorAction* generatorAction
   = static_cast<const G02PrimaryGeneratorAction*>
...
void G02RunAction::AddEdep(G4double edep)
{
  fEdep  += edep;
  fEdep2 += edep*edep;
} 
